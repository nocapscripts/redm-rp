...
CREATE DATABASE IF NOT EXISTS `vorpcore` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `vorpcore`;
...
-- Dumping data for table vorpcore.banks: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `bank_users` (
  ...
  `money` double(22,2) DEFAULT (_utf8mb4'0'),
  `gold` double(22,2) DEFAULT (_utf8mb4'0'),
  `items` longtext DEFAULT (_utf8mb4'[]'),
  `invspace` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `name` (`name`),
...
CREATE TABLE IF NOT EXISTS `banneds` (
  ...
  `b_reason` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `b_banned` varchar(100) NOT NULL,
  `b_unban` varchar(100) NOT NULL,
  `b_permanent` tinyint(1) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `characters` (
  ...
  `steamname` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `charidentifier` int NOT NULL AUTO_INCREMENT,
  `group` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT 'user',
  `money` double(11,2) DEFAULT (_utf8mb4'0'),
  `gold` double(11,2) DEFAULT (_utf8mb4'0'),
  `rol` double(11,2) NOT NULL DEFAULT (_utf8mb4'0'),
  `xp` int DEFAULT NULL,
  `healthouter` int DEFAULT (_utf8mb4'500'),
  `healthinner` int DEFAULT (_utf8mb4'100'),
  `staminaouter` int DEFAULT (_utf8mb4'100'),
  `staminainner` int DEFAULT (_utf8mb4'100'),
  `hours` float NOT NULL DEFAULT (_utf8mb4''),
  ...
  `status` varchar(140) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT '{}',
  `meta` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '{}',
  ...
  `skinPlayer` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `compPlayer` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `jobgrade` int DEFAULT NULL,
  `coords` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT (_utf8mb4'{}'),
  `isdead` tinyint(1) DEFAULT NULL,
  `clanid` int DEFAULT NULL,
  `trust` int DEFAULT NULL,
  `supporter` int DEFAULT NULL,
  `walk` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT 'noanim',
  `crafting` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT (_utf8mb4'{"medical":0,"blacksmith":0,"basic":0,"survival":0,"brewing":0,"food":0}'),
  `info` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT (_utf8mb4'{}'),
  `gunsmith` double(11,2) DEFAULT (_utf8mb4''),
  `ammo` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT (_utf8mb4'{}'),
  `clan` int DEFAULT NULL,
  `discordid` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT (_utf8mb4'0'),
  `lastjoined` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT (_utf8mb4'[]'),
  `motel` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT (_utf8mb4'0'),
  `moonshineenty` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT (_utf8mb4'{}'),
...
-- Dumping data for table vorpcore.characters: ~0 rows (approximately)

-- Dumping structure for table vorpcore.character_inventories
...
-- Dumping data for table vorpcore.character_inventories: ~0 rows (approximately)

-- Dumping structure for table vorpcore.doors
CREATE TABLE IF NOT EXISTS `doors` (
  `id` int NOT NULL AUTO_INCREMENT,
  `doorinfo` longtext NOT NULL DEFAULT (_utf8mb4'[]'),
  `job` longtext NOT NULL DEFAULT (_utf8mb4'[]'),
  `item` longtext NOT NULL,
  `break` int DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Dumping data for table vorpcore.doors: ~0 rows (approximately)

-- Dumping structure for table vorpcore.herbalists
...
-- Dumping data for table vorpcore.herbalists: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `horses` (
  ...
  `name` varchar(50) NOT NULL,
  `components` varchar(5000) NOT NULL DEFAULT (_utf8mb4'{}'),
...
-- Dumping structure for table vorpcore.housing
...
CREATE TABLE IF NOT EXISTS `items` (
  ...
  `type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'item_standard',
  `usable` tinyint(1) DEFAULT NULL,
  `id` int NOT NULL AUTO_INCREMENT,
  `metadata` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT (_utf8mb4'{}'),
  `desc` varchar(5550) NOT NULL DEFAULT 'nice item',
  PRIMARY KEY (`item`) USING BTREE,
  UNIQUE KEY `id` (`id`),
  CONSTRAINT `items_chk_1` CHECK (json_valid(`metadata`))
) ENGINE=InnoDB AUTO_INCREMENT=897 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table vorpcore.items: ~730 rows (approximately)
...
-- Dumping structure for table vorpcore.items_crafted
CREATE TABLE IF NOT EXISTS `items_crafted` (
  ...
  CONSTRAINT `items_crafted_chk_1` CHECK (json_valid(`metadata`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Dumping data for table vorpcore.items_crafted: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `loadout` (
  ...
  `dirtlevel` double DEFAULT NULL,
  `mudlevel` double DEFAULT NULL,
  `conditionlevel` double DEFAULT NULL,
  `rustlevel` double DEFAULT NULL,
  `used` tinyint DEFAULT NULL,
  `used2` tinyint DEFAULT NULL,
  `dropped` int NOT NULL DEFAULT '0',
  `comps` longtext NOT NULL DEFAULT (_utf8mb4'{}'),
...
-- Dumping data for table vorpcore.loadout: ~0 rows (approximately)

-- Dumping structure for table vorpcore.mailbox_mails
...
-- Dumping data for table vorpcore.mailbox_mails: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `rooms` (
  ...
  `inventory` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci,
  `identifier` varchar(60) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `charidentifier` int NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- Dumping data for table vorpcore.users: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `wagon_water` (
  `identifier` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_cs DEFAULT '0',
  `charid` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_cs DEFAULT '0',
  `wagon` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_cs DEFAULT '0',
  `water` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_cs DEFAULT '0',
  `wagon_name` varchar(50) CHARACTER SET latin1 COLLATE latin1_general_cs DEFAULT NULL
